    ...
    public function findBySearchText($searchText)
{
    return $this->createQueryBuilder('p')
        ->andWhere('p.nom LIKE :searchText OR p.idp LIKE :searchText OR p.reduction LIKE :searchText ')
...
public function findAllOrderedByNom()
    ...
    public function findAllOrderedByReduction()
    {
        return $this->createQueryBuilder('p')
            ->orderBy('p.reduction', 'ASC')
            ->getQuery()
            ->getResult();
    }

    public function findAllOrderedByDuree()
    {
        return $this->createQueryBuilder('p')
            ->orderBy('p.duree', 'ASC')
            ->getQuery()
